        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                  ...
                  <!--Busqueda-->
<div class="my-2 flex items-center justify-between"><form action="{{route('products.index')}}" class="w-1/2" method="GET">@csrf
  <input type="search" name="ProductSearchBar" class="bg-white w-full shadow rounded border-2" placeholder="Buscar un producto por nombre o descripción" value="{{$productSearch}}"></form>
              ...
              <td class="px-6 py-4 whitespace-nowrap">
                <div class="flex items-center">
                  <div class="flex-shrink-0 h-10 w-10">
                    <img class="h-10 w-10 rounded-full" src="{{asset($products->images->first()->path)}}" alt=""></img>
                  </div>
                  <div class="ml-4">
