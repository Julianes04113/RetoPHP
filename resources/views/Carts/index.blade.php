                            ...
                            <tr>
                                ...
                                <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                                    <span
                                        ...
                                        <span class="relative">Auxilio</span>
                                    </span>
                                </td>
                                <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                                <form method="POST" action="{{route('products.cart.destroy', ['cart'=>$cart->id, 'product'=>$products->id])}}">
                                @csrf @method('DELETE')
                                <button type="button" class="text-white bg-red-300 hover:bg-red-500 focus:ring-4 focus:ring-red-300 font-medium rounded-lg text-sm px-1 py-1 text-center">Borrar del Carrito</button>
                                </form>
                                </td>
                            </tr>
                            @endforeach
